...
## 题目描述
这是一道经典的数学题目，需要仔细分析题目要求，选择合适的数据结构和算法来解决。
...
本题是数学类型的经典题目，我们可以通过多种方法来解决。

## 解法1：常规解法

### 思路分析
这是常规解法方法的实现思路。该方法通过合理利用数学相关的数据结构和算法思想，有效地解决了问题。具体步骤如下：
...
同类型相关题目
` },
  { id: "lc-200", group: "图", icon: "🟡", title: "200. 岛屿数量（中等）", content: `# 200. 岛屿数量（中等）
...
同类型相关题目
` },
  { id: "lc-695", group: "图", icon: "🟡", title: "695. 岛屿的最大面积（中等）", content: `# 695. 岛屿的最大面积（中等）
