...
本书使用 **Go 1.24**（2025 年 2 月发布），所有代码基于此版本。
...
| Go 1.23 | 2024 | range over func（实验性）、timer/Ticker 改进 |
| **Go 1.24** | **2025** | **泛型类型别名、weak 指针、SwissTables map** |
| Go 1.25 | 2025 | testing.L 负载测试、容器感知 GOMAXPROCS |
