...
// C# 大全 - 章节数据聚合入口
// -------------------------------------------------------------
// 完整教程：58 章（前言 + 57 章正文），覆盖 C# 100% 日常开发知识点
// 适用版本：.NET 8 LTS / C# 12
//
// 10 个 batch 文件（2026-09 重构：删除旧版 batch2「面向对象编程」，
// 它与新版 batch3/4「面向对象基础/进阶」章节 id 重复导致路由串章；
// 原 batch1 第十章「调试技巧」移至第九部分作为 ch53；
// 2026-09 补充：新增 batch11「现代语法与工程化入门」4 章覆盖
// C# 12 新语法、DI、单元测试、ASP.NET Core 入门）：
...
//   csharp2-chapters-batch11.js: 工程化补充（ch54-57）
// =============================================================
...
import { chapters as batch11 } from "./csharp2-chapters-batch11";
