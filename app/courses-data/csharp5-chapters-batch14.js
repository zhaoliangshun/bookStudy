...
// -------------------------------------------------------------
// 本批包含 10 章：
//   csharp5-ch69       : 第六十九章 HTTP 客户端
//   csharp5-ch70       : 第七十章 Socket 与 TCP
//   csharp5-ch71       : 第七十一章 UDP 与 IPC
//   csharp5-ch72       : 第七十二章 WebSocket 与 gRPC 简介
//   csharp5-ch73       : 第七十三章 依赖注入与配置
//   csharp5-ch74       : 第七十四章 单元测试
//   csharp5-ch75       : 第七十五章 ASP.NET Core 简介
//   csharp5-ch76       : 第七十六章 EF Core 数据访问
//   csharp5-ch77       : 第七十七章 综合项目实战
//   csharp5-conclusion : 结语与学习路线
//
...
`,
    code: `// ============================================================
// 第七十章 HTTP 客户端 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
// 设置默认请求头（所有请求都会带上）
client.DefaultRequestHeaders.Add("User-Agent", "CSharp5-Tutorial/1.0");
...
public class SimpleHttpClientFactory
{
    ...
    private readonly Dictionary<string, Action<HttpClient>> _configs = new()
    {
        ["github"] = c =>
        {
            ...
            c.DefaultRequestHeaders.Add("User-Agent", "CSharp5-App");
        },
        ["default"] = c =>
        {
...
`,
    code: `// ============================================================
// 第七十一章 Socket 与 TCP —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
`,
    code: `// ============================================================
// 第七十二章 UDP 与 IPC —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
var tempFile = Path.Combine(Path.GetTempPath(), $"csharp5-mmf-{Guid.NewGuid()}.dat");
try
{
    // 从文件创建 MMF
...
`,
    code: `// ============================================================
// 第七十三章 WebSocket 与 gRPC 简介 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
`,
    code: `// ============================================================
// 第七十四章 依赖注入与配置 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
`,
    code: `// ============================================================
// 第七十六章 ASP.NET Core 简介 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
`,
    code: `// ============================================================
// 第七十七章 EF Core 数据访问 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
...
`,
    code: `// ============================================================
// 第七十八章 综合项目实战 —— 可运行演示（net8.0 / C# 12）
// ------------------------------------------------------------
