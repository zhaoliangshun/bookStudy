...
- **.NET 5+**（2020 至今）：.NET Core 的延续，跳过 4.x 避免与 .NET Framework 4.x 混淆。目前最新长期支持版本是 **.NET 10（LTS）**。

> 这本书使用 **.NET 10 LTS** + **C# 14**，所有代码都基于这个版本。这是目前生产环境最推荐的版本。
...
| C# 13.0 | 2024 | params 集合、锁类型、ref struct 泛型改进 |
| **C# 14.0** | **2025** | **扩展成员、字段关键字、隐式 Span、无参实例构造器** |
...
- **Visual Studio for Mac**（macOS，已停更）：微软已于 2024 年 8 月 31 日停止支持。
