...
// 200道LeetCode经典面试题，按类型分组
const allProblems = [
  // ========== 数组 (30题) - batch1-3已有部分，继续补充 ==========
  { id: "lc-1", num: 1, title: "两数之和", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-26", num: 26, title: "删除有序数组中的重复项", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-27", num: 27, title: "移除元素", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-35", num: 35, title: "搜索插入位置", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-53", num: 53, title: "最大子数组和", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-66", num: 66, title: "加一", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-88", num: 88, title: "合并两个有序数组", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-118", num: 118, title: "杨辉三角", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-121", num: 121, title: "买卖股票的最佳时机", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-136", num: 136, title: "只出现一次的数字", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-169", num: 169, title: "多数元素", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-217", num: 217, title: "存在重复元素", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-283", num: 283, title: "移动零", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-448", num: 448, title: "找到所有数组中消失的数字", icon: "🟢", diff: "简单", group: "数组" },
  { id: "lc-11", num: 11, title: "盛最多水的容器", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-15", num: 15, title: "三数之和", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-31", num: 31, title: "下一个排列", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-48", num: 48, title: "旋转图像", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-54", num: 54, title: "螺旋矩阵", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-56", num: 56, title: "合并区间", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-73", num: 73, title: "矩阵置零", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-75", num: 75, title: "颜色分类", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-128", num: 128, title: "最长连续序列", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-152", num: 152, title: "乘积最大子数组", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-238", num: 238, title: "除自身以外数组的乘积", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-287", num: 287, title: "寻找重复数", icon: "🟡", diff: "中等", group: "数组" },
  { id: "lc-42", num: 42, title: "接雨水", icon: "🔴", diff: "困难", group: "数组" },
  ...
  // ========== 字符串 (20题) ==========
  { id: "lc-3", num: 3, title: "无重复字符的最长子串", icon: "🟡", diff: "中等", group: "字符串" },
  { id: "lc-5", num: 5, title: "最长回文子串", icon: "🟡", diff: "中等", group: "字符串" },
  { id: "lc-20", num: 20, title: "有效的括号", icon: "🟢", diff: "简单", group: "字符串" },
  ...
  { id: "lc-152", num: 152, title: "乘积最大子数组", icon: "🟡", diff: "中等", group: "动态规划" },
  ...
  { id: "lc-5", num: 5, title: "最长回文子串", icon: "🟡", diff: "中等", group: "动态规划" },
  { id: "lc-72", num: 72, title: "编辑距离", icon: "🟡", diff: "中等", group: "动态规划" },
  { id: "lc-121", num: 121, title: "买卖股票的最佳时机", icon: "🟢", diff: "简单", group: "动态规划" },
  ...
  { id: "lc-17", num: 17, title: "电话号码的字母组合", icon: "🟡", diff: "中等", group: "回溯" },
  ...
  { id: "lc-122", num: 122, title: "买卖股票的最佳时机 II", icon: "🟡", diff: "中等", group: "贪心" },
  ...
  { id: "lc-35", num: 35, title: "搜索插入位置", icon: "🟢", diff: "简单", group: "二分查找" },
  ...
  // ========== 栈与队列 (15题) ==========
  { id: "lc-20", num: 20, title: "有效的括号", icon: "🟢", diff: "简单", group: "栈与队列" },
  ...
  { id: "lc-394", num: 394, title: "字符串解码", icon: "🟡", diff: "中等", group: "栈与队列" },
  { id: "lc-622", num: 622, title: "设计循环队列", icon: "🟡", diff: "中等", group: "栈与队列" },
  { id: "lc-946", num: 946, title: "验证栈序列", icon: "🟡", diff: "中等", group: "栈与队列" },

  // ========== 哈希表 (10题) ==========
  { id: "lc-1", num: 1, title: "两数之和", icon: "🟢", diff: "简单", group: "哈希表" },
  { id: "lc-49", num: 49, title: "字母异位词分组", icon: "🟡", diff: "中等", group: "哈希表" },
  { id: "lc-128", num: 128, title: "最长连续序列", icon: "🟡", diff: "中等", group: "哈希表" },
  ...
  // ========== 位运算 (8题) ==========
  { id: "lc-136", num: 136, title: "只出现一次的数字", icon: "🟢", diff: "简单", group: "位运算" },
  ...
  { id: "lc-338", num: 338, title: "比特位计数", icon: "🟢", diff: "简单", group: "位运算" },
  ...
  { id: "lc-66", num: 66, title: "加一", icon: "🟢", diff: "简单", group: "数学" },
  { id: "lc-69", num: 69, title: "x 的平方根", icon: "🟢", diff: "简单", group: "数学" },
  ...
  // ========== 设计题 (7题) ==========
  { id: "lc-146", num: 146, title: "LRU 缓存", icon: "🟡", diff: "中等", group: "设计题" },
  { id: "lc-155", num: 155, title: "最小栈", icon: "🟡", diff: "中等", group: "设计题" },
  ...
  { id: "lc-297", num: 297, title: "二叉树的序列化与反序列化", icon: "🔴", diff: "困难", group: "设计题" },
  ...
  { id: "lc-9", num: 9, title: "回文数", icon: "🟢", diff: "简单", group: "字符串" },
  { id: "lc-13", num: 13, title: "罗马数字转整数", icon: "🟢", diff: "简单", group: "字符串" },
  ...
  { id: "lc-109", num: 109, title: "有序链表转换二叉搜索树", icon: "🟡", diff: "中等", group: "链表" },
...
const finalProblems = uniqueProblems.slice(0, 200);

console.log(`Total problems: ${finalProblems.length}`);
...
function generateProblemContent(p) {
  ...
  const solutions = {
    "lc-1": {
      desc: "给定一个整数数组 nums 和一个整数目标值 target，请你在该数组中找出和为目标值 target 的那两个整数，并返回它们的数组下标。你可以假设每种输入只会对应一个答案，并且你不能使用两次相同的元素。",
      approaches: [
        {
          name: "暴力枚举",
...
class Solution {
    public int[] twoSum(int[] nums, int target) {
      ...
      notes: "1. 注意重复元素的处理：先查找再插入，避免使用同一个元素两次\n2. 数组中可能有负数，哈希表方法天然支持\n3. 题目保证有且只有一个答案",
      similar: "15. 三数之和、18. 四数之和、167. 两数之和 II、454. 四数相加 II"
    }
  };

  // 默认解法模板
  const defaultSolution = {
    desc: "这是一道经典的" + group + "题目，需要仔细分析题目要求，选择合适的数据结构和算法来解决。",
    approaches: [
      {
        name: "常规解法",
        py: generatePythonCode(num, title, group),
        java: generateJavaCode(num, title, group),
        time: "O(n)",
        space: "O(n)"
      }
    ],
  ...
  const sol = solutions[p.id] || defaultSolution;
...
本题是${group}类型的经典题目，我们可以通过多种方法来解决。

`;

  sol.approaches.forEach((approach, idx) => {
    content += `## 解法${idx + 1}：${approach.name}

### 思路分析
${getApproachDesc(p.id, approach.name, group)}
...
function generatePythonCode(num, title, group) {
  const templates = {
...
def solution(root):
    ...
    backtrack([], 0)
    return res`,
    "贪心": `def solution(nums):
    res = 0
    for num in nums:
        pass
    return res`,
    "二分查找": `def solution(nums, target):
    ...
    for c in s:
        if stack:
            ...
            stack.append(c)
    return len(stack) == 0`,
    "哈希表": `def solution(nums):
    d = {}
    for num in nums:
        d[num] = d.get(num, 0) + 1
    return list(d.keys())`,
    "位运算": `def solution(nums):
    res = 0
    for num in nums:
        res ^= num
    return res`,
...
function generateJavaCode(num, title, group) {
  const templates = {
    "数组": `class Solution {
...
function getApproachDesc(id, name, group) {
  return `这是${name}方法的实现思路。该方法通过合理利用${group}相关的数据结构和算法思想，有效地解决了问题。具体步骤如下：
...
// 分成batch，每10题一个文件
const batches = [];
for (let i = 0; i < finalProblems.length; i += 10) {
  batches.push(finalProblems.slice(i, i + 10));
}

console.log(`Creating ${batches.length} batch files...`);

// 删除已有的batch文件（batch1-3保留，因为它们有更详细的内容）
// 先生成所有batch，但是batch1-3我们手动保留更详细的版本
for (let batchIdx = 0; batchIdx < batches.length; batchIdx++) {
  const batchNum = batchIdx + 1;
  const batch = batches[batchIdx];
  const filePath = path.join(leetcodeDir, `leetcode-chapters-batch${batchNum}.js`);
  
  // 对于batch1-3，如果文件已存在，我们跳过（因为已有更详细内容）
  if (batchNum <= 3 && fs.existsSync(filePath)) {
    console.log(`Skipping batch${batchNum} (already exists with detailed content)`);
    continue;
  }
